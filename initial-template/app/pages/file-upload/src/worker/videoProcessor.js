...
var WebMMuxer = (() => {
  ...
  var Writer = class {
    constructor() {
      ...
      __privateAdd(
        this,
        _helperView,
        new DataView(__privateGet(this, _helper).buffer)
      );
    ...
    writeEBMLVarInt(value, width = measureEBMLVarInt(value)) {
      ...
      switch (width) {
        case 1:
          ...
          break;
        case 2:
          __privateGet(this, _helperView).setUint8(
            pos++,
            (1 << 6) | (value >> 8)
          );
    ...
    writeEBML(data) {
      ...
      if (data instanceof Uint8Array) {
        ...
        __privateMethod(this, _writeUnsignedInt, writeUnsignedInt_fn).call(
          this,
          data.id
        );
        if (Array.isArray(data.data)) {
          ...
          let sizeSize =
            data.size === -1 ? 1 : (_a = data.size) != null ? _a : 4;
          if (data.size === -1) {
          ...
          let size =
            (_b = data.size) != null ? _b : measureUnsignedInt(data.data);
          ...
          __privateMethod(this, _writeString, writeString_fn).call(
            this,
            data.data
          );
          ...
          __privateMethod(this, _writeFloat32, writeFloat32_fn).call(
            this,
            data.data.value
          );
        } else if (data.data instanceof EBMLFloat64) {
          this.writeEBMLVarInt(8);
          __privateMethod(this, _writeFloat64, writeFloat64_fn).call(
            this,
            data.data.value
          );
        }
  ...
  var ArrayBufferTargetWriter = class extends Writer {
    ...
    write(data) {
      __privateMethod(this, _ensureSize, ensureSize_fn).call(
        this,
    ...
    finalize() {
      ...
      __privateGet(this, _target).buffer = __privateGet(this, _buffer).slice(
        0,
        this.pos
      );
    }
  ...
  var StreamTargetWriter = class extends Writer {
    ...
    flush() {
      ...
      let chunks = [];
      let sorted = [...__privateGet(this, _sections)].sort(
        (a, b) => a.start - b.start
      );
      chunks.push({
      ...
      for (let chunk of chunks) {
        ...
        if (
          __privateGet(this, _ensureMonotonicity) &&
          chunk.start < __privateGet(this, _lastFlushEnd)
        ) {
    ...
    finalize() {
      var _a, _b;
      (_b = (_a = __privateGet(this, _target2)).onDone) == null
        ? void 0
        : _b.call(_a);
    }
  };
  ...
  var _target3,
    ...
    _chunks,
    _lastFlushEnd2,
    _ensureMonotonicity2,
    _writeDataIntoChunks,
    writeDataIntoChunks_fn,
    _insertSectionIntoChunk,
    insertSectionIntoChunk_fn,
    _createChunk,
    createChunk_fn,
    _flushChunks,
    flushChunks_fn;
  var ChunkedStreamTargetWriter = class extends Writer {
    constructor(target, ensureMonotonicity) {
      ...
      __privateSet(
        this,
        _chunkSize,
        (_b = (_a = target.options) == null ? void 0 : _a.chunkSize) != null
          ? _b
          : DEFAULT_CHUNK_SIZE
      );
      __privateSet(this, _ensureMonotonicity2, ensureMonotonicity);
      if (
        !Number.isInteger(__privateGet(this, _chunkSize)) ||
        __privateGet(this, _chunkSize) < __pow(2, 10)
      ) {
        throw new Error(
    ...
    write(data) {
      __privateMethod(this, _writeDataIntoChunks, writeDataIntoChunks_fn).call(
        this,
        data,
        this.pos
      );
    ...
    finalize() {
      ...
      (_b = (_a = __privateGet(this, _target3)).onDone) == null
        ? void 0
        : _b.call(_a);
    }
  };
  ...
  writeDataIntoChunks_fn = function (data, position) {
    let chunkIndex = __privateGet(this, _chunks).findIndex(
      (x) =>
        x.start <= position &&
        position < x.start + __privateGet(this, _chunkSize)
    );
    if (chunkIndex === -1)
      chunkIndex = __privateMethod(this, _createChunk, createChunk_fn).call(
        this,
        position
      );
    ...
    let toWrite = data.subarray(
      0,
      Math.min(
        __privateGet(this, _chunkSize) - relativePosition,
        data.byteLength
      )
    );
    ...
    __privateMethod(
      ...
      _insertSectionIntoChunk,
      insertSectionIntoChunk_fn
    ).call(this, chunk, section);
    if (
      chunk.written[0].start === 0 &&
      chunk.written[0].end === __privateGet(this, _chunkSize)
    ) {
  ...
  createChunk_fn = function (includesPosition) {
    let start =
      Math.floor(includesPosition / __privateGet(this, _chunkSize)) *
      __privateGet(this, _chunkSize);
    let chunk = {
      start,
  ...
  flushChunks_fn = function (force = false) {
    for (let i = 0; i < __privateGet(this, _chunks).length; i++) {
      ...
      for (let section of chunk.written) {
        if (
          __privateGet(this, _ensureMonotonicity2) &&
          chunk.start + section.start < __privateGet(this, _lastFlushEnd2)
        ) {
          throw new Error("Internal error: Monotonicity violation.");
        }
  ...
  var _options,
    ...
    _writeEBMLHeader,
    writeEBMLHeader_fn,
    _createCodecPrivatePlaceholders,
    createCodecPrivatePlaceholders_fn,
    _createColourElement,
    createColourElement_fn,
    _createSeekHead,
    createSeekHead_fn,
    _createSegmentInfo,
    createSegmentInfo_fn,
    _createTracks,
    createTracks_fn,
    _createSegment,
    createSegment_fn,
    ...
    _segmentDataOffset,
    segmentDataOffset_get,
    _writeVideoDecoderConfig,
    writeVideoDecoderConfig_fn,
    _fixVP9ColorSpace,
    fixVP9ColorSpace_fn,
    _createInternalChunk,
    createInternalChunk_fn,
    _validateTimestamp,
    validateTimestamp_fn,
    _writeSimpleBlock,
    writeSimpleBlock_fn,
    _createCodecPrivateElement,
    createCodecPrivateElement_fn,
    _writeCodecPrivate,
    writeCodecPrivate_fn,
    _createNewCluster,
    createNewCluster_fn,
    _finalizeCurrentCluster,
    finalizeCurrentCluster_fn,
    _ensureNotFinalized,
  ...
  var Muxer = class {
    constructor(options) {
      ...
      var _a;
      __privateMethod(this, _validateOptions, validateOptions_fn).call(
        this,
        options
      );
      __privateSet(
      ...
      if (options.target instanceof ArrayBufferTarget) {
        __privateSet(
          this,
          _writer,
          new ArrayBufferTargetWriter(options.target)
        );
      } else if (options.target instanceof StreamTarget) {
        __privateSet(
          this,
          _writer,
          ((_a = options.target.options) == null ? void 0 : _a.chunked)
    ...
    addVideoChunk(chunk, meta, timestamp) {
      ...
      this.addVideoChunkRaw(
        data,
        chunk.type,
        timestamp != null ? timestamp : chunk.timestamp,
        meta
      );
    }
    addVideoChunkRaw(data, type, timestamp, meta) {
      ...
      let internalChunk = __privateMethod(
        this,
        _createInternalChunk,
        createInternalChunk_fn
      ).call(this, data, type, timestamp, VIDEO_TRACK_NUMBER);
      if (__privateGet(this, _options).video.codec === "V_VP9")
        __privateMethod(this, _fixVP9ColorSpace, fixVP9ColorSpace_fn).call(
          this,
          internalChunk
        );
      __privateSet(this, _lastVideoTimestamp, internalChunk.timestamp);
      while (
        __privateGet(this, _audioChunkQueue).length > 0 &&
        __privateGet(this, _audioChunkQueue)[0].timestamp <=
          internalChunk.timestamp
      ) {
        let audioChunk = __privateGet(this, _audioChunkQueue).shift();
        __privateMethod(this, _writeSimpleBlock, writeSimpleBlock_fn).call(
          this,
          audioChunk
        );
      }
      if (
        ...
        internalChunk.timestamp <= __privateGet(this, _lastAudioTimestamp)
      ) {
        __privateMethod(this, _writeSimpleBlock, writeSimpleBlock_fn).call(
          this,
          internalChunk
    ...
    addAudioChunkRaw(data, type, timestamp, meta) {
        ...
        if (__privateGet(this, _options).streaming) {
          __privateSet(
            ...
            __privateMethod(
              ...
              _createCodecPrivateElement,
              createCodecPrivateElement_fn
            ).call(this, meta.decoderConfig.description)
          );
        } else {
          __privateMethod(this, _writeCodecPrivate, writeCodecPrivate_fn).call(
            this,
      ...
      let internalChunk = __privateMethod(
        ...
        _createInternalChunk,
        createInternalChunk_fn
      ).call(this, data, type, timestamp, AUDIO_TRACK_NUMBER);
      __privateSet(this, _lastAudioTimestamp, internalChunk.timestamp);
      while (
        __privateGet(this, _videoChunkQueue).length > 0 &&
        __privateGet(this, _videoChunkQueue)[0].timestamp <=
          internalChunk.timestamp
      ) {
      ...
      if (
        ...
        internalChunk.timestamp <= __privateGet(this, _lastVideoTimestamp)
      ) {
        __privateMethod(this, _writeSimpleBlock, writeSimpleBlock_fn).call(
          this,
          internalChunk
    ...
    finalize() {
      while (__privateGet(this, _videoChunkQueue).length > 0)
        __privateMethod(this, _writeSimpleBlock, writeSimpleBlock_fn).call(
          this,
          __privateGet(this, _videoChunkQueue).shift()
        );
      while (__privateGet(this, _audioChunkQueue).length > 0)
        __privateMethod(this, _writeSimpleBlock, writeSimpleBlock_fn).call(
          this,
          __privateGet(this, _audioChunkQueue).shift()
        );
      if (!__privateGet(this, _options).streaming) {
        __privateMethod(
          this,
      ...
      if (!__privateGet(this, _options).streaming) {
        ...
        let segmentSize =
          __privateGet(this, _writer).pos -
          __privateGet(this, _segmentDataOffset, segmentDataOffset_get);
        __privateGet(this, _writer).seek(
          __privateGet(this, _writer).offsets.get(
            __privateGet(this, _segment)
          ) + 4
        );
        __privateGet(this, _writer).writeEBMLVarInt(
          segmentSize,
          SEGMENT_SIZE_BYTES
        );
        __privateGet(this, _segmentDuration).data = new EBMLFloat64(
          __privateGet(this, _duration)
        );
        __privateGet(this, _writer).seek(
          __privateGet(this, _writer).offsets.get(
            __privateGet(this, _segmentDuration)
          )
        );
        __privateGet(this, _writer).writeEBML(
          __privateGet(this, _segmentDuration)
        );
        __privateGet(this, _seekHead).data[0].data[1].data =
          __privateGet(this, _writer).offsets.get(__privateGet(this, _cues)) -
          __privateGet(this, _segmentDataOffset, segmentDataOffset_get);
        __privateGet(this, _seekHead).data[1].data[1].data =
          __privateGet(this, _writer).offsets.get(
            __privateGet(this, _segmentInfo)
          ) - __privateGet(this, _segmentDataOffset, segmentDataOffset_get);
        __privateGet(this, _seekHead).data[2].data[1].data =
          __privateGet(this, _writer).offsets.get(
            __privateGet(this, _tracksElement)
          ) - __privateGet(this, _segmentDataOffset, segmentDataOffset_get);
        __privateGet(this, _writer).seek(
          __privateGet(this, _writer).offsets.get(__privateGet(this, _seekHead))
        );
  ...
  createFileHeader_fn = function () {
    ...
    __privateMethod(this, _createColourElement, createColourElement_fn).call(
      this
    );
    if (!__privateGet(this, _options).streaming) {
  ...
  createTracks_fn = function () {
    ...
    if (__privateGet(this, _options).audio) {
      __privateSet(
        this,
        _audioCodecPrivate,
        __privateGet(this, _options).streaming
          ? __privateGet(this, _audioCodecPrivate) || null
          : {
              id: 236 /* Void */,
              size: 4,
              data: new Uint8Array(CODEC_PRIVATE_MAX_SIZE),
  ...
  segmentDataOffset_get = function () {
    return __privateGet(this, _writer).dataOffsets.get(
      __privateGet(this, _segment)
    );
  };
  ...
  fixVP9ColorSpace_fn = function (chunk) {
    ...
    i += 2;
    let profile =
      (readBits(chunk.data, i + 1, i + 2) << 1) +
      readBits(chunk.data, i + 0, i + 1);
    i += 2;
    if (profile === 3) i++;
  ...
  createInternalChunk_fn = function (data, type, timestamp, trackNumber) {
    let adjustedTimestamp = __privateMethod(
      this,
      _validateTimestamp,
      validateTimestamp_fn
    ).call(this, timestamp, trackNumber);
    let internalChunk = {
      data,
      type,
  ...
  validateTimestamp_fn = function (timestamp, trackNumber) {
    let firstTimestamp =
      trackNumber === VIDEO_TRACK_NUMBER
        ? __privateGet(this, _firstVideoTimestamp)
        : __privateGet(this, _firstAudioTimestamp);
    let lastTimestamp =
      trackNumber === VIDEO_TRACK_NUMBER
        ? __privateGet(this, _lastVideoTimestamp)
        : __privateGet(this, _lastAudioTimestamp);
    if (
...
`
  ...
  writeSimpleBlock_fn = function (chunk) {
    ...
    // );
    let clusterIsTooLong =
      chunk.type !== "key" &&
      msTime - __privateGet(this, _currentClusterTimestamp) >=
        MAX_CHUNK_LENGTH_MS;
    if (clusterIsTooLong) {
      // console.log("msTime", msTime);
      // console.log(
      ...
      // );
      const MSTIME = msTime;
      const CLUSTERTIMESTAMP = __privateGet(this, _currentClusterTimestamp);
      debugger;
      throw new Error(
    ...
    //   console.log("msTime", msTime);
    //   console.log("chunk.trackNumber", chunk.trackNumber);
    //   console.log("VIDEO_TRACK_NUMBER", VIDEO_TRACK_NUMBER);
    //   console.log(
    //     "__privateGet(this, _options).video",
    //     __privateGet(this, _options).video
    //   );
    //   console.log(
    //     "chunk.trackNumber === VIDEO_TRACK_NUMBER || !__privateGet(this, _options).video",
    //     chunk.trackNumber === VIDEO_TRACK_NUMBER ||
    //       !__privateGet(this, _options).video
    //   );
    //   console.log(
    //     "msTime - __privateGet(this, _currentClusterTimestamp) >= 1e3",
    //     msTime - __privateGet(this, _currentClusterTimestamp) >= 1e3
    //   );
    //   console.log(
    //     "__privateGet(this, _currentCluster)",
    //     __privateGet(this, _currentCluster)
    //   );
    // }
    ...
    if (
      ...
      __privateMethod(this, _createNewCluster, createNewCluster_fn).call(
        this,
        msTime
      );
    }
    ...
    __privateSet(
      this,
      _duration,
      Math.max(__privateGet(this, _duration), msTime)
    );
  };
  ...
  writeCodecPrivate_fn = function (element, data) {
    let endPos = __privateGet(this, _writer).pos;
    __privateGet(this, _writer).seek(
      __privateGet(this, _writer).offsets.get(element)
    );
    element = [
      __privateMethod(
        this,
  ...
  createNewCluster_fn = function (timestamp) {
    ...
    __privateSet(this, _currentCluster, {
      ...
      data: [{ id: 231 /* Timestamp */, data: timestamp }],
    });
  ...
  finalizeCurrentCluster_fn = function () {
    let clusterSize =
      __privateGet(this, _writer).pos -
      __privateGet(this, _writer).dataOffsets.get(
        __privateGet(this, _currentCluster)
      );
    let endPos = __privateGet(this, _writer).pos;
    __privateGet(this, _writer).seek(
...
export default class VideoProcessor {
  ...
  constructor({ mp4Demuxer, mp4OriginalInfo, encoderConfig, service }) {
    ...
    this.#webMMuxer = new WebMMuxer.Muxer({
      target: new WebMMuxer.StreamTarget(
        (data, position) => {
          this.#muxerStreamWriter.write({ data, position });
        },
        () => {
          // debugger;
          ...
          onChunk(chunk) {
            if (chunk.video) {
              if (chunk.video.type === "key") {
                ...
                videoOrder.push(false);
              }
              videoDecoder.decode(chunk.video);
            }
            if (chunk.audio) {
              audioDecoder.decode(chunk.audio);
            }
          },
        });
      },
  ...
  encode144p(encoderConfig) {
    ...
    const writable = new WritableStream({
      async write(frame) {
        ...
        if (frame.video) {
          const keyFrame = videoOrder.shift();
          _videoEncoder.encode(frame.video, {
            keyFrame,
          });
          frame.video.close();
        }
        ...
        if (frame.audio) {
          _audioEncoder.encode(frame.audio);
          frame.audio.close();
        }
      },
      close() {
  ...
  renderDecodedFramesAndGetEncodedChunks(renderFrame) {
    ...
    return new TransformStream({
      ...
      /**
       *
       * @param {object{video: EncodedVideoChunk} | object{video: EncodedVideoChunk}} encodedChunk
       * @param {TransformStreamDefaultController} controller
       */
      async transform(encodedChunk, controller) {
        if (encodedChunk.video) {
          // debugger;
          if (encodedChunk.meta.decoderConfig) {
            // debugger;
            await _videoDecoder.configure(encodedChunk.meta.decoderConfig);
            // return;
          }
          _videoDecoder.decode(encodedChunk.video);
        }
  ...
  transformIntoWebM() {
    ...
    return {
      readable: this.#muxerStream.readable,
      writable,
    };
  }
